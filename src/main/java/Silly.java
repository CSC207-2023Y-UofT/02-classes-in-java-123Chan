...
public class Silly implements Comparable<Silly>{
     ...
     *
     * @param name1 first name for this Silly instance's name.
     * @param name2 last name for this Silly instance's name.
     */
    ...
    public int compareTo(Silly other) {
        ...
        return Integer.compare(this_length, other_length);
    }
